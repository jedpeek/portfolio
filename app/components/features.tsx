            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              ...
              <span className="relative whitespace-nowrap text-blue-500">
                <svg
                  ...
                  viewBox="0 0 249 22"
                  fill="currentColor"
                  className="absolute inset-x-0 -bottom-0.5 fill-blue-400/75"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 md:mb-20">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base text-zinc-500">
                  Small experienced team that specializes in quick communication
            ...
            <div className="flex items-start gap-3">
              <div className="rounded-full bg-zinc-800 text-white p-2 w-12 h-12 flex items-center justify-center">
                <svg
                  ...
                  className="tabler-icon tabler-icon-device-mobile "
                >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base text-zinc-500">
                  Website and Application designed to ensure optimal display on
                  any device.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="rounded-full bg-zinc-800 text-white p-2 w-12 h-12 flex items-center justify-center">
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  className="tabler-icon tabler-icon-growth "
                >
            ...
            <div className="flex items-start gap-3">
              <div className="rounded-full bg-zinc-800 text-white p-2 w-12 h-12 flex items-center justify-center">
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  className="tabler-icon tabler-icon-tools "
                >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base text-zinc-500">
                  Ability to update and customize sites quickly. Sameday updates
                  available!
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base text-zinc-500">
                  Utilize for Vercel for quick and stable deployment.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base text-zinc-500">
                  Websites are designed to be flexible and easily expand to your
                  changing needs.
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex justify-center gap-6 md:gap-12 [&amp;>svg]:w-12 [&amp;>svg]:h-12 ">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="tabler-icon tabler-icon-brand-react "
              >
              ...
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="tabler-icon tabler-icon-brand-nextjs "
              >
              ...
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="tabler-icon tabler-icon-brand-tailwind "
              >
              ...
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="tabler-icon tabler-icon-brand-vercel "
              >
